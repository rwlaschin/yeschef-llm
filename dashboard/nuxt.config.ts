...
export default defineNuxtConfig({
  ...
  alias: {
    ...
    // Prompt-fragment placement vocabulary + marker layout — shared with the worker and compose.js.
    // MUST be an alias: a relative "../../config/…" resolves correctly on disk but Nitro rewrites
